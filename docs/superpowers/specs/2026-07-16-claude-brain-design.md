...
**Fecha:** 2026-07-16
**Autor:** Francisco Cruz (con Claude Code)
**Estado:** Aprobado

## 1. Propósito

`claude-brain` es un repositorio personal, independiente de cualquier proyecto de
cliente, que centraliza todo el conocimiento reutilizable de Francisco para trabajar
...
"segundo cerebro" de Francisco para IA Engineering.
