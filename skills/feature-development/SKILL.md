...
- El pedido es mejorar código existente sin cambiar comportamiento externo —
  usá el playbook [`refactor-code`](../../playbooks/refactor-code.md).
...
1. **Decidir si hace falta diseño previo.** Señales de que sí: el cambio toca
   ...
   [ADR](../../templates/adr.md) o [RFC](../../templates/rfc.md) antes de
...
- [ ] La PR describe qué se agregó y por qué (ver [`templates/pull-request.md`](../../templates/pull-request.md)).
