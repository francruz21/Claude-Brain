# ADR 003: Usar Conventional Commits como convención por defecto en claude-brain
...
`claude-brain` necesita una convención de mensajes de commit de referencia
...
- **Gitmoji**: agrega expresividad visual, pero no es un estándar tan
  extendido en equipos con los que trabaja Francisco — se descartó por
